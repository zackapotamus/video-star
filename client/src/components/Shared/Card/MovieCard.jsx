    ...
    <>
      <div className="card shadow">
        ...
        <div className="card_title">
          ...
          <div className="card_video__details">
            <ul style={{ listStyleType: "none" }}>
              <li>
                ...
                {moment(props.video.release_date).format("MMMM Do, YYYY")}
              </li>
              <li>
                <strong>Budget:</strong>{" "}
                {`$${numberWithCommas(props.video.budget)}`}
              </li>
              <li>
                <strong>Runtime:</strong> {formatRuntime(props.video.runtime)}
              </li>
          ...
          <hr />
          <div
            className="card_video__synopsis"
            style={{ marginLeft: 30, marginRight: 30 }}
          >
            <p>
              <strong>Synopsis:</strong> {props.video.overview}
            </p>
          </div>
          <hr />
          <div className="card_video__homepage text-center">
            <a
              href={props.video.homepage}
              rel="noopener noreferrer"
              target="_blank"
            >
              <button className="btn btn-sm btn-outline-success my-2 my-sm-0">
                Movie Homepage
              </button>
            </a>
          </div>
